      ...
      'The theme was free text and is now one of two words. What happens to stored themes, and where is the version stamp on a bare word?',
      {
        ...
        proof: Story.trace(
          Effect.gen(function* () {
            ...
            const seen = yield* Theme.decode({ _v: 'v1', _value: 'night' });
