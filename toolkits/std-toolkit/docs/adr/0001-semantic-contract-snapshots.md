...
The storage-ownership decision is superseded by ADR 0003, the change-reporting shape is superseded by ADR 0004, and the use of Effect Schema representations (with transformation and limitation tracking) is superseded by ADR 0016. The remaining decisions still apply.
