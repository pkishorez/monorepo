...
import type { DynamoDBClientError } from '../../../domain/client-error/index.js';
...
export interface DynamoDBClientService {
  ...
  describeContributorInsights(
    ...
    InternalServerError | ResourceNotFoundException | DynamoDBClientError
  >;
  describeEndpoints(
    input: DescribeEndpointsRequest,
  ): Effect.Effect<DescribeEndpointsResponse, DynamoDBClientError>;
  describeExport(
  ...
  describeImport(
    ...
    ImportNotFoundException | DynamoDBClientError
  >;
  ...
  describeLimits(
    ...
    InternalServerError | InvalidEndpointException | DynamoDBClientError
  >;
  describeTable(
  ...
  listExports(
    ...
    ListExportsOutput,
    InternalServerError | LimitExceededException | DynamoDBClientError
  >;
  listGlobalTables(
  ...
  listImports(
    ...
    ListImportsOutput,
    LimitExceededException | DynamoDBClientError
  >;
  listTables(
