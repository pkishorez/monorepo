...
import { coalesceStrategy as makeCoalesceStrategy } from './coalesce-strategy.js';
import { buildPacedUpdate as makePacedUpdate } from './build-paced-update.js';

export const coalesceStrategy = makeCoalesceStrategy;
export const buildPacedUpdate = makePacedUpdate;
