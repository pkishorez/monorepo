...
const runSimulation = <const D extends readonly AnyDefinition[], A, E>(
  ...
  Effect.gen(function* () {
    ...
    const flowId = `tanstack-sync-story::${runtime.runSync(nextUlid)}`;
...
// Todo fixture shared by the TanStack Sync stories
...
export const storyTable = StdTable.make('tanstack-sync-stories')
  .primary('pk', 'sk')
  .build();
