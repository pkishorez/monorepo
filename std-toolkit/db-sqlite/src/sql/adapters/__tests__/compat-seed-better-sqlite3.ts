...
await Effect.runPromise(
  Effect.gen(function* () {
    ...
    yield* sqliteDB.insert("compat_test", { id: "bs3-1", name: "Alice", age: 30, active: "true" });
    yield* sqliteDB.insert("compat_test", { id: "bs3-2", name: "Bob", age: 25, active: "false" });
    yield* sqliteDB.insert("compat_test", { id: "bs3-3", name: "Charlie", age: 35, active: "true" });
