...
/**
 * The Laymos project picker: add a project by absolute path, open an existing
...
export function ProjectManager({ onSelected }: { onSelected?: () => void }) {
  ...
  const selectedPath = useProjectStore((s) => s.selectedPath);
            ...
            return (
              ...
              >
                ...
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  title={copiedPath === p.path ? 'Copied' : 'Copy project path'}
                  aria-label={
                    copiedPath === p.path
                      ? 'Project path copied'
                      : 'Copy project path'
