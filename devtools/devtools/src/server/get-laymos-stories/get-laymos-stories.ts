...
import { ConfigError, getStoryTree, StoriesError } from 'laymos';
import {
  ConfigParseError,
  ConfigReadError,
  ConfigSchemaError,
...
export function getLaymosStories(projectPath: string) {
  return Effect.gen(function* () {
    ...
    return yield* getStoryTree(join(absolute, 'laymos.config.json')).pipe(
