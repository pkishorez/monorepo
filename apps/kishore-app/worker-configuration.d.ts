/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eaa54b93b6110c536bcbc9b1500b2d62)
// Runtime types generated with workerd@1.20260305.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/server');
    durableNamespaces: 'HelloWorldDO';
  }
  interface Env {
    BETTER_AUTH_SECRET: SecretsStoreSecret;
    OPENROUTER_API_KEY: string;
    BETTER_AUTH_SECRET: string;
    HELLO_WORLD_DO: DurableObjectNamespace<import('./src/server').HelloWorldDO>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'OPENROUTER_API_KEY' | 'BETTER_AUTH_SECRET'>
  > {}
}
