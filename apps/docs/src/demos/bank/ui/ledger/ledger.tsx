...
const scrollBox =
  '-mx-3.5 h-[30rem] min-h-[8rem] shrink overflow-x-hidden overflow-y-auto overscroll-contain px-3.5 [scrollbar-color:var(--border)_transparent] [scrollbar-gutter:stable] [scrollbar-width:thin]';
