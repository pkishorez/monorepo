...
import { useCachedStoreName } from '../../session/rpc-session/index.ts';
import { ExplorerTree } from './explorer-tree.tsx';
import { StoreOverview, StackOverview } from './overview-pane.tsx';
import { StagePane } from './stage-pane.tsx';
import { ResourcePanel } from './resource-panel.tsx';
import type { ExplorerLocation, NavigationLink } from './explorer-view.tsx';

export type { ExplorerLocation } from './explorer-view.tsx';
...
export function StoreExplorer({
  ...
  const storeName = useCachedStoreName(storeId);
