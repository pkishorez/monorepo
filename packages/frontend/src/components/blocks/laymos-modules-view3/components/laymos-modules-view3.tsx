...
import type { LaymosModulesView3Props } from '../types';
import { canHoverModule, getModuleGraphActiveModel } from '../lib/connectivity';
...
export function LaymosModulesView3(props: LaymosModulesView3Props) {
  return (
    <ReactFlowProvider>
      <LaymosModulesView3Inner {...props} />
    </ReactFlowProvider>
  );
}

function LaymosModulesView3Inner({
  report,
  selectedModule,
