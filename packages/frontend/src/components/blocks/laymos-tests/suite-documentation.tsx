...
/** Renders optional suite Markdown behind an initially open disclosure. */
export function SuiteDocumentation({
  markdown,
}: {
  ...
  return (
    ...
    >
      ...
      <CollapsibleContent className="overflow-hidden border-t">
        <div className="prose prose-sm max-w-none px-4 py-3 text-foreground dark:prose-invert prose-headings:mb-2 prose-headings:mt-4 prose-p:my-2 prose-li:my-0.5 prose-pre:border prose-pre:border-border prose-pre:bg-muted/45">
