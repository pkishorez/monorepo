  ...
  WorkflowRpcs.of({
    'workflow.execute.start': (params) =>
      Effect.gen(function* () {
        ...
        Effect.withSpan('rpc.workflow.execute.start', {
    ...
    'workflow.execute.continue': (params) =>
      Effect.gen(function* () {
        ...
        Effect.withSpan('rpc.workflow.execute.continue', {
    ...
    'workflow.execute.stop': (params) =>
      Effect.gen(function* () {
        ...
        Effect.withSpan('rpc.workflow.execute.stop', {
          attributes: { workflowId: params.workflowId },
        }),
      ),
    'workflow.execute.remove': (params) =>
      Effect.gen(function* () {
        ...
        Effect.withSpan('rpc.workflow.execute.remove', {
          attributes: { workflowId: params.workflowId },
        }),
      ),
    'workflow.archive': (params) =>
      Effect.gen(function* () {
        ...
        Effect.withSpan('rpc.workflow.archive', {
          attributes: { workflowId: params.workflowId },
        }),
      ),
